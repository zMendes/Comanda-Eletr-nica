...
while running:
    ...
    if menu =="2":
        ...
        if escolha=="comanda":
            print("Essas são as comandas em aberto: {0}".format(lista_comandas))
            comanda=input("Qual comanda deseja acessar: ")
            if comanda not in lista_comandas:
                lista_comandas.append(comanda)
            pedido = input("Faça sua escolha: ")
            if pedido in cardapio:
                quantidade= int(input("Quantidade: "))
                comanda=dict(pedido=quantidade)
    ...
    if menu =="3":
        ...
        if escolha=='comanda':
            comanda=input("De qual comanda deseja remover o item: ")
    ...
    if menu=="4":
        print(lista_comandas)
        comanda=input("Qual comanda deseja imprimir: ")
        total=0
        for item in comanda:
